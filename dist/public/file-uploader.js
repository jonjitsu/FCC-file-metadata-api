...
listenTo = function listenTo(elem, cb) {
  if (elem.addEventListener) elem.addEventListener('submit', cb, true);else if (elem.attachEvent) elem.attachEvent('onsubmit', cb);else throw new Error('Browser not supported');
},
